  ...
  return (
      <>
        ...
        >
          ...
          <div className="container mx-auto p-4 flex lg:flex-row flex-col relative z-20">
            ...
            >
              <div className="grid grid-cols-2 gap-4 h-full items-center cursor-default">
                {services.map((service, index) => (
                    <HomeServiceCard
                        key={index}
                        title={service.title}
                        description={service.description}
                        progressValue={service.progressValue}
                    />
                ))}
              </div>
            </div>
